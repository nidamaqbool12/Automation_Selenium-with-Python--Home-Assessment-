...
<img width="1139" height="576" alt="image" src="https://github.com/user-attachments/assets/f500eab7-1763-4d82-b922-0d8516b09e91" />

<img width="926" height="101" alt="image" src="https://github.com/user-attachments/assets/208a782b-f81b-4cb0-a08e-646038ac381f" />
...
<img width="1420" height="547" alt="image" src="https://github.com/user-attachments/assets/2200e130-387b-4fa1-a5ce-39c5dfde1773" />

<img width="1402" height="514" alt="image" src="https://github.com/user-attachments/assets/a5c1de7a-197d-4d3f-8b2c-01260c8b516e" />

<img width="1311" height="624" alt="image" src="https://github.com/user-attachments/assets/061fbe16-8d30-4459-9c5a-80446ba74f34" />

# Viewing the Automation Test Report

When the automation script runs, **two HTML files are generated**:

1. ## Automation_Report.html – Generated every time you run the script in PyCharm. This file contains the latest test execution results.
   
   <img width="1907" height="796" alt="image" src="https://github.com/user-attachments/assets/e74c1084-fb3a-4d99-84cd-7ad1ab65bdf3" />
   
   <img width="721" height="656" alt="image" src="https://github.com/user-attachments/assets/a62d387a-72c2-44e8-8cdb-0b9bd84a1a67" />


2. ## Automation_Test_Report.html  – Generated by the CI/CD pipeline defined in the GitHub Actions workflow (`.yml` file). This file can be downloaded from the **Artifacts** section in GitHub Actions after the workflow completes.

<img width="1311" height="616" alt="image" src="https://github.com/user-attachments/assets/18cc54ba-75c6-4d24-b724-84c64239e436" />

<img width="1849" height="786" alt="image" src="https://github.com/user-attachments/assets/0227eff9-371d-49f6-815c-b1474267e1eb" />


### Steps to view the CI/CD report in GitHub Actions

1. Navigate to the **Actions** tab in your GitHub repository.  
2. Select the most recent workflow run.  
3. Scroll down to the **Artifacts** section and download `Automation_Test_Report.html` to view the detailed test execution log.
...
<img width="1336" height="594" alt="image" src="https://github.com/user-attachments/assets/fdf98771-86a9-49ae-a4aa-db4d9f9041cb" />

<img width="1329" height="632" alt="image" src="https://github.com/user-attachments/assets/33e58aa2-cfe7-4244-b435-af155aa42a9d" />
