...
## 1. Automation_Report.html 

– Generated every time you run the script in PyCharm. This file contains the latest test execution results.
...
<img width="721" height="656" alt="image" src="https://github.com/user-attachments/assets/a62d387a-72c2-44e8-8cdb-0b9bd84a1a67" />
 ...
 ## 2. Automation_Test_Report.html
   
– Generated by the CI/CD pipeline defined in the GitHub Actions workflow (`.yml` file). This file can be downloaded from the **Artifacts** section in GitHub Actions after the workflow completes.
